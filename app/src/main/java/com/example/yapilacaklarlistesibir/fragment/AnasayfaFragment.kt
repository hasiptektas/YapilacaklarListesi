...
import com.example.yapilacaklarlistesibir.adapter.YapilacaklarAdapter
...
import com.example.yapilacaklarlistesibir.viewmodel.AnasayfaVMF
...
class AnasayfaFragment : Fragment() , SearchView.OnQueryTextListener{
    ...
    fun fabTikla(v : View) {
        Navigation.findNavController(v).navigate(R.id.yapilacaklarKayitGecis)
    }
